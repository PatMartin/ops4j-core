...
public class Pipeliner
{
  public static void main(final String[] args)
  {
    ...
    disruptor.handleEventsWith(new ParallelHandler(0, 3),
        new ParallelHandler(1, 3), new ParallelHandler(2, 3))
  ...
  private static class ParallelHandler implements EventHandler<PipelinerEvent>
  {
    ...
    @Override
    public void onEvent(final PipelinerEvent event, final long sequence,
